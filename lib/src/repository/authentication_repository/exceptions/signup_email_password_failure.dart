class SignUpWithEmailAndPasswordFailure {
  ...
  const  SignUpWithEmailAndPasswordFailure([this.message = "An Unknown error ocurred"]);
  ...
  factory SignUpWithEmailAndPasswordFailure.code(String code){
    switch(code){
      ...
      case 'user-disable'           : return const SignUpWithEmailAndPasswordFailure('This user has beendisabled. Please contact support for help.');
